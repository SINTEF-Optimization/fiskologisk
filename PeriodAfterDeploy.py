class PeriodAfterDeploy:
    ...
    def __init__(self, expected_weight: float, feed_cost: float, oxygen_cost: float, growth_factor: float, transferred_growth_factor: float, weight_distribution: list[float]) -> None:
